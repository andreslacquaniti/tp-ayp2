...
// ------------------------------------------------------------
// CALCULAR LA LÍNEA DEL HORIZONTE EXPUESTA
// ------------------------------------------------------------

// Calcula y devuelve la línea del horizonte para una lista de edificios.
// Los edificios deben estar ordenados por su coordenada x1.
func CalcularLineaHorizonte(edificios []Edificio) []Punto {
	// La función interna `lineaHorizonte` ya espera los edificios ordenados.
	// Si esta función fuera llamada externamente sin garantizar el orden,
	// se debería agregar sort.Slice(edificios, ...) aquí.
	return lineaHorizonte(edificios)
}
package horizon
